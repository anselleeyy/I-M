...
public class AccessFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (pathMatcher.match(UrlPattern.SWAGGER, path) || pathMatcher.match(UrlPattern.MUSIC_CENTER, path)
            || pathMatcher.match(UrlPattern.USER_REGISTER, path) || pathMatcher.match(UrlPattern.USER_LOGIN, path)
